		...
		<tr>
			<td valign="top">
				...
				<fieldset class="adminform" style="width:90%" id="textfieldset">
					...
					<textarea style="width:98%" rows="20" name="data[mail][altbody]" id="altbody" placeholder="<?php echo JText::_('AUTO_GENERATED_HTML'); ?>" onClick="zoneToTag='altbody';"><?php echo @$this->mail->altbody; ?></textarea>
				</fieldset>
			</td>
