...
<?php	
	...
	if (uddeIMcheckJversion()>=5) {	// only Joomla 3.0, bug (not) fixed in Joomla 3.1
		echo '<ul class="nav nav-tabs" id="uddeim">';
		...
		<table width="100%" border="0" cellpadding="4" cellspacing="2" class="adminForm" id="adminForm">
			<tr align="center" valign="middle">
				<td align="left" valign="top">
					...
					PMS component for Mambo 4.5, Joomla 1.0, 1.5, 1.6, 1.7, 2.5, 3.0, and 3.1<br />
					&copy; 2007-2013 Stephan Slabihoud, &copy; 2005-2006 by Benjamin Zweifel</p>
