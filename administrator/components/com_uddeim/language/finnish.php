...
// Description    Instant Messages System for Mambo 4.5 / Joomla 1.0 / Joomla 1.5 / Joomla 2.5
// Author         © 2007-2012 Stephan Slabihoud, © 2006 Benjamin Zweifel
...
// Site: http://www.joomla.fi
//
// Author: © 2007-2012 Sami Haaranen
// Finnish Joomla! Translation Team
// Site: http://www.joomla.fi
// Email: mortti[at]joomla.fi
// *******************************************************************
// For version: uddeIM 2.9 Stable
// Dated: 08.09.2012
// Translation version: 2.9
...
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Kielitiedoston käännös © 2007-2012 <a href="http://www.joomla.fi" target="_new">Sami Haaranen aka Mortti</a>');	// Empty for English and German language files, enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
DEFINE ('_UDDEADM_POSTBOXFULL_HEAD', 'Viestin teksti kokonaisuudessaan');
DEFINE ('_UDDEADM_POSTBOXFULL_EXP', 'Näytä viestin koko teksti tai ei mitään, ensin tai kaikissa viesteissä.');
DEFINE ('_UDDEADM_POSTBOXFULL_0', 'Ei mitään');
DEFINE ('_UDDEADM_POSTBOXFULL_1', 'Ensin');
DEFINE ('_UDDEADM_POSTBOXFULL_2', 'Kaikki');
DEFINE ('_UDDEADM_POSTBOXAVATARS_HEAD', 'Näytä pikkukuvat');
DEFINE ('_UDDEADM_POSTBOXAVATARS_EXP', 'Näytä pikkukuvat viestinäkymässä.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_12', '...aseta viestilaatikko oletukseksi (valinnat)');

// New: 2.8
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_11', '...aseta viestilaatikko oletukseksi');
DEFINE ('_UDDEADM_POSTBOX_HEAD', 'Ota käyttöön viestilaatikko');
DEFINE ('_UDDEADM_POSTBOX_EXP', 'Ottaa käyttöön viestilaatikon.');
DEFINE ('_UDDEIM_FILTER_TITLE_POSTBOX', 'Näytä tältä/tälle käyttäjälle vain');
DEFINE ('_UDDEIM_MESSAGES', 'Viestit');
DEFINE ('_UDDEIM_POSTBOX', 'Viestilaatikko');
DEFINE ('_UDDEIM_FILTEREDUSER', 'käyttäjä suodatettu');
DEFINE ('_UDDEIM_FILTEREDUSERS', 'käyttäjää suodatettu');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_POSTBOX', ' viestilaatikko');
DEFINE ('_UDDEIM_NOMESSAGES_POSTBOX', 'Sinulla ei ole viestejä viestilaatikossa.');
DEFINE ('_UDDEIM_DISPLAY', 'Näytä');
DEFINE ('_UDDEIM_HELP_POSTBOX', '<b>Viestilaatikko</b> sisältää kaikki sinun saapuvat ja lähtevät viestit.');
DEFINE ('_UDDEIM_HELP_PREAD', 'Viesti on luettu (saapuneet=voit vaihtaa tilaa).');
DEFINE ('_UDDEIM_HELP_PUNREAD', 'Viestiä ei ole vielä luettu (saapuneet=voit vaihtaa tilaa).');

// New: 2.7
DEFINE ('_UDDEADM_MOOTOOLS_NONEMEIO', 'älä lataa MooToolsia (käytä MEIO)');
DEFINE ('_UDDEADM_MOOTOOLS_13MEIO', 'pakota MooTools 1.3 lataus (käytä MEIO)');

// New: 2.6
DEFINE ('_UDDEADM_DONTSEFMSGLINK_HEAD', 'Ei SEF %msglink% muuttujalle');
DEFINE ('_UDDEADM_DONTSEFMSGLINK_EXP', 'Älä käytä SEF %msglink% muuttujalle sähköposti-ilmoituksissa.');
DEFINE ('_UDDEADM_STIME_HEAD', 'Käytä erikoiskalenteria');
DEFINE ('_UDDEADM_STIME_EXP', 'Kun otetaan käyttöön sivustolla jossa farsi kielitiedosto, Persian kalenteri on käytössä.');
DEFINE ('_UDDEADM_RESTRICTREM_HEAD', 'Poista orvot yhteydet');
DEFINE ('_UDDEADM_RESTRICTREM_EXP', 'Poista orvot yhteydet automaattisesti, kun tallennetaan löytyvä kontaktilista.');
DEFINE ('_UDDEADM_RESTRICTCON_HEAD', 'Näytä vain yhteydet');
DEFINE ('_UDDEADM_RESTRICTCON_EXP', 'Listan käyttäjien näkymistä voidaan rajoittaa CB/CBE/JS yhteyksillä (piilota käyttäjät käyttäjälistalta ei ole vaikutusta tähän, kun käytössä).');
DEFINE ('_UDDEADM_RESTRICTCON0', 'ei käytössä');
DEFINE ('_UDDEADM_RESTRICTCON1', 'rekisteröityneet käyttäjät');
DEFINE ('_UDDEADM_RESTRICTCON2', 'rekisteröityneet, erikoiskäyttäjät');
DEFINE ('_UDDEADM_RESTRICTCON3', 'kaikki käyttäjät (sisältää ylläpitäjät)');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_10', '...aseta oletukseksi yhteyksien näyttö');
...
// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', '\'Pysäytä sähköpostit\' on käytössä.');
