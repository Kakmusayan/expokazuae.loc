...
* @version $Id: default_language.php 1686 2012-02-04 14:15:51Z beat $
...
DEFINE('_UE_BY','A Joomla 2.5, 1.7, 1.6, 1.5 and 1.0, and Mambo 4.6.3, 4.5.2-4.5.5 and compatible systems component by');
...
.' new password you can log in and change it.');
...
// 1.2.1 Stable:
DEFINE('_UE_MALE','Male');
DEFINE('_UE_FEMALE','Female');
// 1.2.2 backend:
...
DEFINE('_UE_ENABLESPOOFCHECK_DESC','Choose if you want spoof checking enabled on sessions (highly recommended unless you have difficulty with session expired and cookie errors when enabled). Disabled by default for best stability and usability.');DEFINE('_UE_SITE_FIRSTNAME','Name');DEFINE('_UE_SITE_DOLZHNOST','Post');DEFINE('_UE_SITE_TELEFON','Phone');DEFINE('_UE_SITE_COMPANY','Company');DEFINE('_UE_SITE_CITY','City');DEFINE('_UE_SITE_COUNTRY','Country');DEFINE('_UE_SITE_ADRESS','Address');DEFINE('_UE_SITE_SUBSCRIBE','Subscribe');DEFINE('_UE_SITE_SUBSCRIBE_TYPE','Subscribe type');DEFINE('_UE_SITE_LOGIN','Login');DEFINE('_UE_SITE_PASSWORD','Password');
