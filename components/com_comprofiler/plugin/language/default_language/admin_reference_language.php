...
* @version $Id: admin_reference_language.php 1897 2012-10-31 23:57:45Z beat $
...
'Single word ( /^[a-z]*$/i )' => 'Single word ( /^[a-z]*$/i )',
'Multiple words with spaces ( /^([a-z]+ *)*$/i )' => 'Multiple words with spaces ( /^([a-z]+ *)*$/i )',
...
'Signature' => 'Signature',
'Field settings for signature.' => 'Field settings for signature.',
...
'WARNING: CMS registration is still enabled in CMS Users Manager Component Options !' => 'WARNING: CMS registration is still enabled in CMS Users Manager Component Options !',
'This may be ok, but this warning is just to make you aware users can bypass Community Builder registration using CMS registration.' => 'This may be ok, but this warning is just to make you aware users can bypass Community Builder registration using CMS registration.',
'Maximum emails per hour' => 'Maximum emails per hour',
'Set maximum emails per hour a user can send to another user using built in email form. Default is 10 emails per hour.' => 'Set maximum emails per hour a user can send to another user using built in email form. Default is 10 emails per hour.',
