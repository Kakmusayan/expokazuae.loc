...
DEFINE('_UE_VPASS','Пароль повторно');
...
.'<p>Ваша регистрация требует одобрения. По одобрению, Вам будет отправлено соответствующее сообщение по указанному Вами при регистрации адресу эл.почты.</p>'
...
.'<p>Ваш пароль был отправлен по введенному Вами адресу эл.почты.</p>'
.'<p>Пожалуйста проверьте Вашу эл.почту (включая папку для спама). Когда Вы получите Ваш пароль и выполните инструкции по подтверждению своего аккаунта, то Вы сможете войти на сайт.</p>');
...
DEFINE('_UE_USER_CONFIRMED','Ваш аккаунт теперь активирован. Вы можете войти на сайт!');
...
.'<p>Ваша регистрация требует подтверждения по эл.почте и одобрения администратором. Пожалуйста следуйте пошаговым инструкциям, присланным Вам по эл.почте</p>'
.'<p>Когда Вы получите одобрение, то Вам будет отправлен пароль и Вы тогда сможете войти на сайт.</p>');
...
if (!defined('_REGISTER_TITLE'))	DEFINE('_REGISTER_TITLE','Регистрация <br><div class="datex">Пожалуйста, заполните все поля</div>');
...
DEFINE('_UE_CAPTCHA_Label','Код подтверждения');
DEFINE('_UE_CAPTCHA_Enter_Label','Введите код подтверждения');
...
DEFINE('_LOGIN_TITLE','ВХОД В ЛИЧНЫЙ КАБИНЕТ');
...
DEFINE('_UE_LOST_PASSWORD_DESC','Если Вы <strong>потеряли Ваш пароль</strong>, но знаете свое имя пользователя, пожалуйста введите свое имя пользователя и адрес Вашей эл.почты, щелкните на кнопку "Отправить пароль" и Вы вскоре получите Ваш новый пароль. Используйте этот новый пароль для входа на сайт.');
...
DEFINE('_UE_SITE_FIRSTNAME','ФИО');
DEFINE('_UE_SITE_DOLZHNOST','Должность');
DEFINE('_UE_SITE_TELEFON','Телефон');
DEFINE('_UE_SITE_COMPANY','Компания');
DEFINE('_UE_SITE_CITY','Город');
DEFINE('_UE_SITE_COUNTRY','Страна');
DEFINE('_UE_SITE_ADRESS','Адрес');
DEFINE('_UE_SITE_SUBSCRIBE','Подписка');
DEFINE('_UE_SITE_SUBSCRIBE_TYPE','Тип подписки');
