...
* @version $Id: cbteamplugins_language.php 1639 2011-12-08 09:19:16Z beat $
...
'Image: [img size=(01-499)]http://www.google.com/images/web_logo_left.gif[/img]' => 'Изображение: [img size=(01-499)]http://www.google.com/images/web_logo_left.gif[/img]',
...
'This tab contains a basic no-frills image Gallery for CB profiles' => 'Эта вкладка содержит рудиментарную, безхитросную галерею изображений для профилей CB',
'Current Items' => 'Текущие объекты',
'Keeps track of number of stored items' => 'Следит за числом сохраненных объектов',
'Date of last update to Gallery items in this profile' => 'Дата последнего обновления объектов галереи этого профиля',
...
'Item Quota' => 'Квота на объекты',
'The admin may use this to over-ride the default value of allowable items for each profile owner' => 'Администратор может использовать это для перезаписи значения по умолчанию числа разрешенных объектов для каждого владельца профиля',
'No Items published in this profile gallery' => 'В галерее этого профиля опубликованных объектов не существует',
'Title:' => 'Заголовок:',
...
'A gallery item title must be entered' => 'Необходимо ввести заголовок объекта галереи',
'Autopublish items' => 'Опубликовать объекты автоматически',
'Select Yes or No to autopublish or not newly uploaded gallery items' => 'Выберите "Да" или "Нет" для автоматической публикации только что загруженных объектов галереи',
'Current Storage' => 'Нынешний размер диска',
'This field keeps track of the total size of all uploaded gallery items - like a quota usage field. Value is in bytes.' => 'Это поле следит за полным размером всех загруженных объектов галереи, как, например, поле использования квоты (значение в bytes).',
'Greetings - connections only viewing enabled' => 'Приветствия - включен просмотр только для связей',
'Sorry - connections only viewing enabled for this gallery that currently has %1$d items in it.' => 'Извините - для этой галереи, которая в настоящее время имеет %1$d объектов, включен просмотр только для связей.',
...
'Maximum allowable single upload size exceeded - gallery item rejected' => 'Максимальная квота файла для загрузки превышена - объект галереи отвергнут',
 ...
 */
' [Your current quota marks: %1$d/%2$d items %3$d/%4$d Kbytes (%5$d%% consumed - %6$d%% free)]' => ' [Ваша квота в настоящее время: %1$d/%2$d объекты %3$d/%4$d Kbytes (%5$d%% употреблено - %6$d%% свободно) - размер разовой загрузки %7$d Kbytes]',
'This file would cause you to exceed you quota - gallery item rejected' => 'Этот файл привел бы к превышению отведенной Вам квоты - объект галлереи отвергнут',
'Access Mode' => 'Вид доступа',
'Select desirable access mode: Public access, Registered users only, Connected users only, REG-S for Registered-stealth, CON-S for Connections-stealth' => 'Выберите желаемый вид доступа: Все, только Зарегистрированные пользователи, только связанные пользователи, REG-S для Скрытно-зарегистрированных, CON-S для Скрытно-связанных',
'Allow Public Access' => 'Разрешить допуск всем',
'Allow Registered Access' => 'Разрешить допуск зарегистрированным',
'Allow Connections Access' => 'Разрешить допуск связанным',
'Registered Stealth Access' => 'Допуск скрытно-зарегистрированным',
'Connections Stealth Access' => 'Допуск скрытно-связанным',
...
'Pictures gallery list format' => 'Формат списка изображений галереи',
...
'Image ToolBox failure! - Please notify system admin - ' => 'Ошибка "Image Toolbox" - Пожалуйста известите системного администратора - ',
...
'Only Registered Members Allowed to view the %1$d items in this Gallery!' => 'Только зарегистрированным членам разрешается просматривать  %1$d объект(а/ов) в этой галерее!',
'Delete' => 'Удалить',
'Publish' => 'Публиковать',
'Unpublish' => 'Не публик.',
'Approve' => 'Одобрить',
...
'Are you sure you want to delete selected item ? The selected item will be deleted and cannot be undone!' => 'Вы в самом деле хотите удалить выбранный объект? Он будет удален безвозвратно!',
...
'This tab contains all pending autorization gallery items' => 'Эта вкладка содержит все ожидающие одобрения объекты галереи',
'New Gallery Item just uploaded' => 'Только что был загружен новый объект галереи',
/**
...
=>
"Новый объект галереи только что был загружен и, возможно, должен быть рассмотрен администратором.\n"
."Это эл.письмо содержит подробности об этом объекте\n\n"
."Тип объекта галереи - %1\$s\n"
."Заголовок объекта галереи - %2\$s\n"
."Описание объекта галереи - %3\$s\n\n"
...
'Your Gallery Item has been approved!' => 'Объект Вашей гелереи был одобрен!',

"A Gallery item in your Gallery Tab has just been approved by a moderator.\n\n\n"
."Please do not respond to this message as it is automatically generated and is for information purposes only\n"
=>
"Объект во вкладке Вашей галереи была только что одобрен модератором.\n\n\n"
."Пожалуйста не отвечайте на это сообщение, поскольку оно создано автоматически в чисто информационных целях\n",

'Your Gallery Item has been revoked!' => 'Объект Вашей галереи был отозван!',
...
."Please do not respond to this message as it is automatically generated and is for information purposes only\n"
=>
"Объект в Вашей вкладке галереи была только что отозван модератором.\n\n\n"
."Если Вы чувствуете что эти действия являются неоправданными, пожалуйста свяжитесь с одним из наших модераторов.\n"
."Пожалуйста не отвечайте на это сообщение, поскольку оно создано автоматически в чисто информационных целях\n",

'Your Gallery Item has been deleted!' => 'Объект Вашей галереи был успешно удален!',

"A Gallery item in your Gallery Tab has just been deleted by a moderator.\n\n\n"
."If you feel that this action is unjustified please contact one of our moderators.\n"
."Please do not respond to this message as it is automatically generated and is for information purposes only\n"
=>
"Объект в Вашей вкладке галереи был только что удален модератором.\n\n\n"
."Если Вы чувствуете что эти действия являются неоправданными, пожалуйста свяжитесь с одним из наших модераторов.\n"
."Пожалуйста не отвечайте на это сообщение поскольку оно создано автоматически в чисто информационных целях\n",

'Your Gallery item is pending approval by a site moderator.' => 'Объект Вашей галереи ожидает одобрения модератором сайта.',
'Your Gallery item quota has been reached. You must delete an item in order to upload a new one or you may contact the admin to increase your quota.' => 'Вы достигли квоты, отведенной объектам Вашией галереи. Вам нужно либо удалить один из них, прежде чем загружать новый или связаться с администратором с просьбой увеличить квоту.',
...
'Image ' => 'Изображение ',
' of ' => ' из ',
'Image {x} of {y}' => 'Изображение {x} из {y}',
 ...
 */
'No Viewable Items' => 'Объектов для просмотра нет',
'No items rendered' => 'Никаких объектов не выдано',

'Edit Gallery Item' => 'Редактировать объект галереи',
'Edit' => 'Изменить',
'Update' => 'Обновить',

'Bad File - Item rejected' => 'Файл с ошибкой - объект отвергнут',
'Not logged on' => 'Не авторизован',
'No connected items' => 'Связанных объектов нет'
) );

// Privacy plugin: (new method: UTF8 encoding here):
CBTxt::addStrings( array(
'Visible on profile'					=>	'Видимый на профиле',
'Only to logged-in users'				=>	'Только авторизованным пользователям',
'Only for direct connections'			=>	'Только для прямых связей',
'Only for %s'							=>	'Только для %s',
'Also for connections\' connections'	=>	'Также для связей внутри связей',
'Invisible on profile'					=>	'Невидимый на профиле',
'Access only to logged-in users. Please login.'						=>	'Доступ только для авторизованных пользователей. Пожалуйста авторизуйтесь.',
...
'Access only with login'											=>	'Доступ только для авторизованных',
'Access only to directly connected users'							=>	'Доступ только для связанных напрямую пользователей',
'Access only to directly connected users and friends of friends'	=>	'Доступ только для связанных напрямую пользователей и друзей своих друзей',
));
...
'%s and %s are now connected'			=>	'%s и %s теперь связаны',
'%s is now connected to %s'				=>	'%s сейчас связан с %s',
'%s are now connected to %s'			=>	'%s сейчас связаны с %s',

'%s added a new picture'				=>	'%s добавил новое изображение',
'%s added new pictures'					=>	'%s добавил новые изображения',
'%s added %s new pictures'				=>	'%s добавил %s новых изображений',
