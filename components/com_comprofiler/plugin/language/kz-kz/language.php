...
* @version $Id: language.php 1040 2010-06-07 14:07:06Z beat $
...
DEFINE('_UE_EMAIL','Адрес эл.почты');
DEFINE('_UE_UNAME','Аты-жөні');
DEFINE('_UE_PASS','Пароль');
DEFINE('_UE_VPASS','Парольді қайталау');
...
DEFINE('_UE_ALLOW_EMAIL_USERCONTR','Скрыть адрес эл.почты пользователя');
...
DEFINE('_UE_ONLINESTATUS','Статус нахождения на сайте');
...
DEFINE('_UE_REGISTRATION','Тіркелу');
...
DEFINE('_UE_VERSION','Ваша версия компонента <strong>Community Builder</atrong>: ');
DEFINE('_UE_BY','Joomla 1.0 и 1.5, Мамбо 4.5.2-4.5.5 и 4.6.3 и произвольный компонент совместимых систем от ');
DEFINE('_UE_CURRENT_SETTINGS','Текущие настройки');
DEFINE('_UE_A_EXPLANATION','Описание');
DEFINE('_UE_DISPLAY','Показать');
DEFINE('_UE_REQUIRED','Обязательно');
DEFINE('_UE_YES','Да');
DEFINE('_UE_NO','Нет');
...
DEFINE('_UE_PICTLIST','Список изображений');
DEFINE('_UE_PICTDETAIL','Данные изображения');
...
DEFINE('_UE_ALLOW_EMAIL_REPLYTO','Эл.почта отправлена "От:"');
DEFINE('_UE_ALLOW_EMAIL_REPLYTO_DESC','Настройки для отправляемых пользователю форм эл.почты. Для форматирования поля отправителя "От" выберите одну из следующих опций:<ol>'
		.'<li>"От пользователя": без поля "Кому ответить", пользователь получает все ответы и сообщения об ошибках, что укрепляет приватность его электронной почты;</li>'
		.'<li>"От администратора": с полем "Кому ответить" с адресом эл.почты пользователя.<br/>Это находится в полном соответствии с анти-спамными требованиями SPF, но администратор может получить ошибки/ошибочно созданные ответы.</li></ol>');
DEFINE('_UE_A_FROM_USER', 'От пользователя');
DEFINE('_UE_A_FROM_ADMIN', 'От администратора, с "Кому ответить": пользователь');
...
DEFINE('_UE_NAME_FORMAT_DESC','Выбрать в каком формате Вы бы желали отображать поля Имя/Аты-жөні.');
...
DEFINE ('_UE_REG_EMAIL_REPLYTO_DESC','Адрес эл.почты, который бы Вы хотели использовать в поле "Кому ответить".');
...
DEFINE ('_UE_REG_WELCOME_SUB_DESC','Заголовок приветствующего письма, отправляемого пользователю по его первой авторизации на сайте после регистрации. Вы можете использовать языковые строчки или оставить заголовок и текст письма пустыми, чтобы принудить неотправку письма.');
DEFINE ('_UE_REG_REJECT_SUB_DESC','Заголовок письма об отказе');
DEFINE ('_UE_REG_SIGNATURE','Подпись письма');
DEFINE ('_UE_REG_ADMIN_PA_SUB','ТРЕБУЕТСЯ ДЕЙСТВИЕ! Тіркелу нового пользователя ожидает одобрения');
...
DEFINE ('_UE_REG_ADMIN_SUB','Тіркелу нового пользователя');
DEFINE ('_UE_REG_ADMIN_MSG','Новый пользователь зарегистрировался на сайте [SITEURL].\n'
.'Это письмо содержит его данные\n\n'
.'Имя - [NAME]\n'
.'Адрес эл.почты - [EMAILADDRESS]\n'
.'Аты-жөні - [USERNAME]\n\n\n'
.'Пожалуйста не отвечайте на это письмо, поскольку оно написано автоматически только для Вашей информации.\n');
DEFINE('_UE_REG_EMAIL_TAGS','[NAME] - Как зовут пользователя<br />'
.'[USERNAME] - Аты-жөні для входа на сайт<br />'
.'[DETAILS] - Регистрационные данные пользователя, такие как адрес эл.почты и Аты-жөні<br />'
.'[PASSWORD] - Пароль, выбранный пользователем (только в первом письме, отправленном в ответ на нажатие кнопки "Регистрировать")<br />'
...
//Registration form
DEFINE('_UE_REG_COMPLETE_NOPASS','<div class="componentheading">Тіркелу завершена!</div>'
.'<p>Ваш пароль был отправлен по введенному Вами адресу эл.почты.</p>'
.'<p>Пожалуйста проверьте свою эл.почту (включая папку для спама). Вы сможете зайти на сайт сразу же по получению своего пароля.</p>');
DEFINE('_UE_REG_COMPLETE','<div class="componentheading">Тіркелу завершена!</div>'
.'<p>Вы теперь можете входить на сайт.</p>');
DEFINE('_UE_REG_COMPLETE_NOPASS_NOAPPR','<div class="componentheading">Тіркелу завершена!</div>'
.'<p>Ваше Тіркелу требует одобрения. По одобрению Ваш пароль будет отправлен Вам по введенному Вами адресу эл.почты.</p>'
.'<p>Когда Вы получите одобрение и пароль, Вы сможете Кіру на сайт.</p>');
DEFINE('_UE_REG_COMPLETE_NOAPPR','<div class="componentheading">Тіркелу завершена!</div>'
.'<p>Ваша Тіркелу требует одобрения. По одобрению, Вам будет отправлено соответствующее сообщение по указанному Вами при регистрации адресу эл.почты.</p>'
.'<p>Когда Вы получите одобрение, Вы сможете Кіру на сайт.</p>');
DEFINE('_UE_REG_COMPLETE_CONF','<div class="componentheading">Тіркелу завершена!</div>'
...
.'<p>Для отправки повторного эл.письма просто попытайтесь Кіру на сайт с паролем и именем пользователя, соответствующими Вашим регистрационным.</p>');
DEFINE('_UE_REG_COMPLETE_NOPASS_CONF','<div class="componentheading">Тіркелу завершена!</div>'
.'<p>Ваш пароль был отправлен по введенному Вами адресу эл.почты.</p>'
.'<p>Пожалуйста проверьте Вашу эл.почту (включая папку для спама). Когда Вы получите Ваш пароль и выполните инструкции по подтверждению своего аккаунта, то Вы сможете Кіру на сайт.</p>');
...
DEFINE ('_UE_ENTER_EMAIL','Введите адрес эл.почты пользователя, имя и Аты-жөні');
DEFINE ('_UE_SEARCH_BUTTON','Поиск');
DEFINE ('_UE_SHOW_ALL','Показать всех пользователей');
DEFINE ('_UE_NAME','Ф И О');
DEFINE ('_UE_UL_USERNAME','Аты-жөні');
...
DEFINE('_UE_CLICKTOSORTBY','Щелкните, чтобы упорядочить по %s');		// %s replaced by sorting name
DEFINE('_UE_UL_USERNAME_NAME','Аты-жөні(Имя)');

//mod_userextraslogin
DEFINE('_UE_NO_ACCOUNT','Еще нет аккаунта?');
DEFINE('_UE_CREATE_ACCOUNT','Создать аккаунт');
DEFINE('_UE_REGISTER','Тіркелу!');
...
DEFINE('_LOGIN_NOT_APPROVED','Ваш аккаунт еще не был одобрен!');
DEFINE('_UE_USER_CONFIRMED','Ваш аккаунт теперь активирован. Вы можете Кіру на сайт!');
DEFINE('_UE_USER_NOTCONFIRMED','Ваш аккаунт еще не активирован. Пожалуйста, проверьте свою эл.почту и последуйте инструкциям для завершения регистрационного процесса. Если Вы не находите такое письмо с инструкциями в своей почте, то, пожалуйста, проверьте свою папку спама. Удостоверьтесь, что Ваша почта не настроена на немедленное удаление спама. Если это так, то попытайтесь еще раз зайти на сайт для получения нового письма с инструкциями.');
...
DEFINE('_UE_UPLOAD_ERROR_NAME','Название файла аватара должно состоять только из буквенно-цифровых знаков и не содержать пробелов.');
...
DEFINE('_UE_NOUNBANREQUESTS','Нет требований по разблокировке для обработки');
DEFINE('_UE_IMAGE_MODERATE','Модерировать изображени');
...
DEFINE('_UE_USERREPORT_MODERATE','Модерировать жалобы пользователя(ей)');
...
DEFINE('_UE_USERREPORTSREQUIREACTION','Жалоба(ы) пользователя(ей)');
DEFINE('_UE_IMAGESREQUIREACTION','Изображение(ия)');
...
DEFINE('_UE_IMAGE_ADMIN_SUB','Изображение ожидает одобрения');
DEFINE('_UE_IMAGE_ADMIN_MSG','Пользователь отправил изображение на одобрение. Пожалуйста зайдите на сайт и предпримите соответствующие меры.');
...
DEFINE('_UE_IMAGEAPPROVED_MSG','Ваше изображение было одобрено модератором.');
DEFINE('_UE_IMAGEREJECTED_SUB','Изображение отвергнуто');
DEFINE('_UE_IMAGEREJECTED_MSG','Ваше изображение было отвергнуто модератором. Пожалуйста зайдите на сайт и отправьте новую.');
...
DEFINE('_UE_MODERATOREMAIL_DESC','Если включено на "Да", то, когда на сайте произойдут действия, требующие внимания и модерации, то модераторы будут получать письма по эл.почте.');
...
DEFINE('_UE_ALLOW_PROFILELINK','Позволить создание ссылки на профиль');
...
DEFINE('_UE_UPLOAD_ERROR_GDNOTINSTALLED','Библиотека картинок GD2 либо не установлена либо не скомпилирована с РНР! Пожалуйста известите Вашего системного администратора, чтобы выключить функцию автоматического изменения размеров изображений.');
DEFINE('_UE_UPLOAD_ERROR_UPLOADFAILED','Во время загрузки/обработки изображения произошла ошибка!');
DEFINE('_UE_TOC','Примите Условия и Соглашения');
DEFINE('_UE_TOC_REQUIRED','Перед регистрацией Вы должны рассмотреть "Условия и Соглашения"!');
...
DEFINE('_UE_REG_TOC_URL_MSG','URL ссылка на "Условия и Соглашения"');
DEFINE('_UE_REG_TOC_URL_DESC','Введите URL ссылку Вашего документа "Условия и Соглашения".');
...
DEFINE('_UE_SENDEMAILNOTICE_DISCLAIMER',"\r\n\r\n------ Заметки: ------\r\n\r\nЭтот пользователь не видел адрес Вашей эл.почты. Если Вы ответите, то у получателя будет Ваш адрес.\r\n\r\n%s владельцы не могут принять никакой ответственности за содержание и адрес писем пользователя.");
DEFINE('_UE_SENDEMAILNOTICE_MESSAGEHEADER',"\r\n\r\n\r\n------ Сообщение от %s Вам: ------\r\n\r\n");
DEFINE('_UE_SENDPMSNOTICE','ЗАМЕТКА: Это сообщение создано автоматически системой связи. В нем находится адрес запрашивающего создание связи пользователя, чтобы Вам можно было удобно на него ответить, если Вы пожелаете.');
DEFINE('_UE_SENDEMAIL','Отправить письмо эл.почты');
DEFINE('_UE_SENTEMAILSUCCESS','Ваше письмо было успешно отправлено!');
DEFINE('_UE_SENTEMAILFAILED','Не удалось отправить Ваше эл.письмо! Пожалуйста попытайтесь еще раз.');
...
DEFINE('_UE_REG_REJECT_SUB','Ваше Тіркелу была отклонена!');
DEFINE('_UE_USERREJECT_MSG',"Ваше Тіркелу на %s была отклонена по следующей причине:\n%s");
...
DEFINE('_UE_REG_COMPLETE_NOAPPR_CONF','<div class="componentheading">Тіркелу завершена!</div>'
.'<p>Ваша Тіркелу требует подтверждения через эл.почту и утверждения. Пожалуйста следуйте пошаговым инструкциям, присланным Вам по эл.почте. По утверждению, по введенному Вами адресу Вам будет отправлено записка о принятии.</p>'
.'<p>Вы сможете Кіру на сайт, когда Вы получите одобрение.</p>');
DEFINE('_UE_REG_COMPLETE_NOPASS_NOAPPR_CONF','<div class="componentheading">Тіркелу завершена!</div>'
.'<p>Ваша Тіркелу требует подтверждения по эл.почте и одобрения администратором. Пожалуйста следуйте пошаговым инструкциям, присланным Вам по эл.почте</p>'
.'<p>Когда Вы получите одобрение, то Вам будет отправлен пароль и Вы тогда сможете Кіру на сайт.</p>');
...
DEFINE('_UE_USER_CONFIRMED_NEEDAPPR','Благодарим за подтверждение Вашего адреса эл.почты. Ваш аккаунт должен быть рассмотрен модератором, результат которого Вы получите по эл.почте.');
...
DEFINE('_UE_MINHITSINTV_DESC','Установить минимальный интервал между подсчетами просмотров профиля пользователя каким-либо пользователем. Настройка по умолчанию - 60 минут (один час).');
DEFINE('_UE_XHTMLCOMPLY','Соответствие стандарту W3C XHTML 1.0 Trans.');
DEFINE('_UE_XHTMLCOMPLY_DESC','Поскольку некоторые шаблоны для систем Joomla/Mambo не включают необходимую декларацию ( &lt;?php mosShowHead(); ?&gt; ),'
.' эта настройка является не обязательной. Вы можете проверить файл index.php Вашего шаблона или просто включить эту настройку и проверить, отображается ли вкладка профиля пользователя.'
...
DEFINE('_UE_USERIMAGEMODERATED_SUCCESSFUL','Изображение пользователя успешно модерировано!');
...
DEFINE('_UE_BLANK','');
DEFINE('_UE_REG_FIRST_VISIT_URL_MSG','URL ссылка первого входа на сайт');
DEFINE('_UE_REG_FIRST_VISIT_URL_DESC','Введите URL ссылку для отображения во время самого первого захода на сайт после регистрации. Эта страница может содержать Ваше сообщение приветствия новым членам и/или особы инструкции, или перенаправить пользователя на завершение его профиля. Оставьте незаполненной для обычного входа 
...
DEFINE('_UE_NOSUCHPROFILE','Этот профиль либо больше не существует, либо больше не доступен.');
...
DEFINE('_UE_USER_NOT_CONFIRMED','Этот пользователь пока не подтвердил ни свой адрес эл.почты, ни свой аккаунт!');
//Connections
...
DEFINE('_UE_CONNECTEDSINCE','Связан, начиная с');
...
DEFINE('_UE_CONNECTOINNOTIFYTYPE_DESC','Выберите здесь, хотите ли Вы получать извещения о связи и каким образом Вы бы хотели, чтобы Ваши пользователи получали извещения о процессе связи.');
...
DEFINE('_UE_CONNECTIONMADESUB','%s связался с Вами!');
...
DEFINE('_UE_CONNECTTO','Связаться с %s');
...
DEFINE('_UE_NEWSLETTER_DESC','Выберите "Нет", если у Вас не установлен компонент для выпуска новостей. В противном случае выберите, какую версию Вы бы хотели интегрировать.');
DEFINE('_UE_NEWSLETTER_DESC2','На данное время поддерживается только "YaNC 1.4" и подписка на публичные выпуски новостей будет предлагаться в конце страницы регистрации.');
...
DEFINE('_UE_NEWSLETTERSREGLIST_DESC2','Многострочный выбор с помощью ctrl (для PC) или command (для Mac) выбрать/удалить выпуск новостей.');
...
DEFINE('_UE_NOZOOMIMGS','У этого пользователя отсутствуют изображения!');
DEFINE('_UE_ZOOMNOTINSTALLED','Компонент наезда на изображения не установлен. Пожалуйста свяжитесь с администратором сайта.');
...
DEFINE('_UE_CONNECT_ACTIONREQUIRED','Внизу Вы видите пользователей, которые предлагают создать связь с Вами. У Вас есть выбор принять или отклонить их запросы. '
...
.'Подвигайте и подержите указатель мыши над иконками чтобы посмотреть короткое пояснение их значения и действий, и над изображениями, чтобы посмотреть подробности связей.');
...
DEFINE('_UE_PM_NEW_MESSAGES'	, 'новые личные сообщения');
...
DEFINE('_UE_REVOKECONNECTIONREQUEST','Отозвать запрос связи');
DEFINE('_UE_REVOKECONNECTIONREQUEST_DESC','Отозвать назад запрос связи с этим пользователем');
...
DEFINE('_UE_UNBAN_MODERATE_DESC','Щелкните на Аты-жөні заблокированного чтобы просмотреть соответствующий профиль. '
...
DEFINE('_UE_MENU_APPROVE_IMAGE_DESC', 'Как модератор сайта: Одобрите изображение, отправленное пользователем для своего профиля, сделав его видимым остальным пользователям');
DEFINE('_UE_MENU_REJECT_IMAGE_DESC', 'Как модератор сайта: Отклоните аватар пользователя для этого профиля');
...
DEFINE('_UE_LASTONLINE_DESC','Этот пользователь был на сайте последний раз:');
...
if (!defined('_REGWARN_NAME'))		DEFINE('_REGWARN_NAME','Пожалуйста введите Ваше имя.');
if (!defined('_REGWARN_UNAME'))		DEFINE('_REGWARN_UNAME','Пожалуйста введите Ваше Аты-жөні.');
if (!defined('_REGWARN_MAIL'))		DEFINE('_REGWARN_MAIL','Пожалуйста введите действительный адрес Вашей эл.почты.');
if (!defined('_REGWARN_VPASS2'))	DEFINE('_REGWARN_VPASS2','Пароли не соответствуют. Пожалуйста попробуйте еще раз.');
if (!defined('_REGWARN_INUSE'))		DEFINE('_REGWARN_INUSE','Это Аты-жөні уже занято. Пожалуйста попробуйте другое.');
...
if (!defined('_NEW_PASS_DESC'))		DEFINE('_NEW_PASS_DESC','Пожалуйста введите Ваше Аты-жөні и адрес эл.почты и затем щелкните на кнопку "Выслать пароль".<br />'
.'Вскоре Вы получите новый пароль.  Для входа на сайт используйте этот новый пароль.');
if (!defined('_PROMPT_UNAME'))		DEFINE('_PROMPT_UNAME','Аты-жөні:');
if (!defined('_PROMPT_EMAIL'))		DEFINE('_PROMPT_EMAIL','Email:');
if (!defined('_BUTTON_SEND_PASS'))	DEFINE('_BUTTON_SEND_PASS','Выслать пароль');
if (!defined('_REGISTER_TITLE'))	DEFINE('_REGISTER_TITLE','Тіркелу <br><div class="datex">Пожалуйста, заполните все поля</div>');
if (!defined('_REGISTER_NAME'))		DEFINE('_REGISTER_NAME','Имя:');
if (!defined('_REGISTER_UNAME'))	DEFINE('_REGISTER_UNAME','Аты-жөні:');
...
.' новый пароль, Вы можете Кіру на сайт и изменить его.');
...
if (!defined('_LOGIN_BLOCKED'))		DEFINE('_LOGIN_BLOCKED','Ваш вход на сайт заблокирован администратором.');
...
if (!defined('_LOGIN_INCORRECT'))	DEFINE('_LOGIN_INCORRECT','Неправильные Аты-жөні или пароль. Пожалуйста, попробуйте еще раз.');
...
DEFINE('_UE_PLEASE_REFRESH','Пожалуйста, прежде чем заполнять форму, перегрузите страницу.');
...
DEFINE('_UE_MOD_MENU_UPDATEAVATAR', 'Обновить аватар пользователя');
DEFINE('_UE_MOD_MENU_UPDATEAVATAR_DESC', 'Выбрать аватар профиля этого пользователя');
DEFINE('_UE_MOD_MENU_DELETE_AVATAR', 'Удалить аватар пользователя');
DEFINE('_UE_MOD_MENU_DELETE_AVATAR_DESC', 'Удалить аватар профиля этого пользователя');
...
DEFINE('_UE_REG_CB_ALLOW_DESC','Позволить ли регистрацию пользователей согласно соответствующей конфигурации в общих настройках Joomla, или любым образом, посредством CB.<br />Рекомендованные параметры: только через CB, - установите "Да" здесь и "Нет" в общих настройках Joomla.');
...
DEFINE('_UE_REG_ALLOWREG_SAME_AS_GLOBAL','Как в общих настройках Joomla "Разрешить регистрацию пользователей"');
...
DEFINE('_UE_REG_NAMEFORMAT_NAME_USERNAME','Имя (Аты-жөні)');
DEFINE('_UE_REG_NAMEFORMAT_USERNAME_ONLY','Только Аты-жөні');
DEFINE('_UE_REG_NAMEFORMAT_USERNAME_NAME','Аты-жөні (Имя)');
...
DEFINE('_UE_REG_EMAILDISPLAY_EMAIL_ONLY','Показывать только email');
DEFINE('_UE_REG_EMAILDISPLAY_EMAIL_W_MAILTO','Показывать адрес эл.почты со ссылкой "Кому ответить"');
...
DEFINE('_UE_REG_USERNAMECHECKER_DESC','Позволяет во время регистрации проверять свободно ли Аты-жөні. Вам стоит помнить что, хотя эта функция защищена, при некоторых обстоятельствах она может быть использована для отгадывания имени, облегчая отгадывание пароля. Эта функция экспериментальная, пока еще не оптимизированная для больших сайтов. Обязательно проводите тщательное тестирование? прежде чем применять ее!');
// 1.1: frontend:
DEFINE('_UE_BUTTON_LOGIN','Кіру');
DEFINE('_UE_BUTTON_LOGOUT','Выйти');
DEFINE('_UE_DO_LOGIN','Вам нужно Кіру.');
DEFINE('_UE_DO_LOGOUT','Вам нужно выйти.');
define('_UE_CHECK_USERNAME_AVAILABILITY',"Проверить свободно ли Аты-жөні");
define('_UE_USERNAME_ALREADY_EXISTS',"Аты-жөні '%s' уже зарегистрировано. Пожалуйста выберите другое.");
define('_UE_USERNAME_DOESNT_EXISTS',"Аты-жөні '%s' не занято. Можете продолжать.");
...
DEFINE('_UE_CAPTCHA_Label','Код');
DEFINE('_UE_CAPTCHA_Enter_Label','Кодты енгізіңіз');
DEFINE('_UE_CAPTCHA_Desc','Введите показанный на изображении код Captcha. Если такое изображение с кодом отсутствует, то попробуйте выключить Ваш блокиратор рекламы и перегрузить эту страницу. В противном случае, пожалуйста свяжитесь с администратором сайта для дальнейшей помощи.');
DEFINE('_UE_CAPTCHA_NOT_VALID','Недействительный код Captcha');
DEFINE('_UE_CAPTCHA_ALT_IMAGE','Изображение с встроенным в ней кодом Captcha');
DEFINE('_UE_CAPTCHA_AUDIO','щелкнуть здесь чтобы услышать буквы');
DEFINE('_UE_CAPTCHA_AUDIO_POPUP_TITLE','Звуковой проигрыш кода Captcha CB');
DEFINE('_UE_CAPTCHA_AUDIO_POPUP_DESCRIPTION','Прослушайте звуковой проигрыш кода Captcha на изображении');
...
DEFINE('_LOGIN_TITLE','Тіркелу/Кіру');
...
DEFINE('_UE_LOST__USERNAME','Потеряно Аты-жөні');
...
.'С Вашего аккаунта %s было запрошено повторное извещение об имени пользователя.\n\n'
.'Ваше Аты-жөні: %s\n\n'
.'Чтобы зайти в Ваш аккаунт, щелкните на ссылку ниже:\n'
.'%s\n\n'
.'Благодарим.\n');
DEFINE('_UE_NEWPASS_SUB','Новый пароль для: %s');
DEFINE('_UE_NEWPASS_MSG','Аккаунту пользователя назначен адрес эл.почты %s.\n'
.'Пользователь на %s только что запросил отправку нового пароля.\n\n'
.'Ваш новый пароль: %s\n\n'
.'Если это не Ваш запрос, не беспокойтесь.'
.' Это сообщение видимо Вам, но не другим. Если это ошибка, то просто войдите на сайт с Вашим'
.' новым паролем и затем измените его согласно Ваших предпочтений.');
DEFINE('_UE_ALREADY_LOGGED_IN','Вы уже вошли на сайт');
DEFINE('_UE_EMAIL_COULD_NOT_CHECK','Не удалось проверить этот адрес эл.почты. Пожалуйста проверьте дважды, это необходимо для подтверждения.');
DEFINE('_UE_EMAIL_COULD_NOT_CHECK_NEEDED','Не удалось проверить 
...
DEFINE('_UE_AVATAR_UPLOAD_DISCLAIMER','Щелкая на "Загрузить", Вы подтверждаете что у Вас есть права на распространение этого изображения.');
...
DEFINE('_UE_LOST_USERNAME_OR_PASSWORD','Потеряли Ваше Аты-жөні или пароль?');
DEFINE('_UE_LOST_USERNAME_DESC','Если вы <strong>потеряли Ваше Аты-жөні</strong>, пожалуйста введите адрес Вашей эл.почты, отправляя поле для ввода имени пользователя не заполненным, затем щелкните на кнопку "Отправить Аты-жөні" и Ваше Аты-жөні будет отправлено Вам по указанному адресу.');
DEFINE('_UE_LOST_USERNAME_ONLY_DESC','Если Вы <strong>потеряли Ваше Аты-жөні</strong>, пожалуйста введите адрес Вашей эл.почты, затем щелкните на кнопку "Отправить Аты-жөні" и Ваше Аты-жөні будет отправлено Вам по указанному адресу.');
DEFINE('_UE_LOST_PASSWORD_DESC','Если Вы <strong>потеряли Ваш пароль</strong>, но знаете свое Аты-жөні, пожалуйста введите свое Аты-жөні и адрес Вашей эл.почты, щелкните на кнопку "Отправить пароль" и Вы вскоре получите Ваш новый пароль. Используйте этот новый пароль для входа на сайт.');
DEFINE('_UE_LOST_USERNAME_PASSWORD_DESC','Если Вы <strong>забыли и Ваше Аты-жөні и Ваш пароль</strong>, пожалуйста сначала восстановите Аты-жөні, а затем пароль. Для восстановления имени пользователя, пожалуйста введите адрес Вашей эл.почты, оставляя поле для имени пользователя пустым, затем щелкните на кнопку "Отправить Аты-жөні" и Ваше Аты-жөні будет отправлено на адрес Вашей эл.почты. Далее Вы можете использовать эту же форму для восстановления Вашего пароля.');
DEFINE('_UE_BUTTON_SEND','Отправить');
DEFINE('_UE_BUTTON_SEND_USERNAME','Отправить Аты-жөні');
DEFINE('_UE_BUTTON_SEND_PASS','Отправить пароль');
DEFINE('_UE_BUTTON_SEND_USERNAME_PASS','Отправить Аты-жөні/пароль');
define('_UE_USERNAME_EXISTS_ON_SITE',"Аты-жөні '%s' уже существует на этом сайте.");
define('_UE_USERNAME_DOES_NOT_EXISTS_ON_SITE',"Аты-жөні '%s' не существует на этом сайте.");
define('_UE_USERNAME_FREE_OK_TO_PROCEED',"Аты-жөні '%s' не занято. Можете продолжать.");
define('_UE_THIS_IS_YOUR_USERNAME',"Это Ваше нынешнее Аты-жөні на этом сайте.");
define('_UE_THIS_IS_USERS_USERNAME',"Это - нынешнее Аты-жөні на этом сайте.");
...
DEFINE('_UE_VALID_UNAME','Пожалуйста, введите действительное Аты-жөні, без пробелов, длинной как минимум из трех знаков и состоящее только из 0-9,a-z,A-Z');
...
DEFINE ('_UE_AGE_YEARS','%s лет/года');
DEFINE ('_UE_YEARS','лет/года');
...
DEFINE('_UE_FB_ORDERING_OLDEST', 'Сначала самые старые сообщения' );
DEFINE('_UE_FB_ORDERING_LATEST', 'Сначала самые новые сообщения' );
DEFINE('_UE_FB_ORDERING_TITLE', 'Порядок сообщений' );
DEFINE('_UE_FB_SIGNATURE', 'Подпись на Вашем форуме' );
...
DEFINE('_UE_FB_NO_FAVORITES_FOUND','Ваших избранные тем не найдено');
...
DEFINE('_UE_PROFILE_GALLERY_DESC','Эта вкладка содержит элементарную и без излишеств галерею изображений для профилей CB');
DEFINE('_UE_PROFILE_GALLERY_MODERATION','Галерея модератора');
DEFINE('_UE_PROFILE_GALLERY_MODERATION_DESC','Эта вкладка содержит все изображения галереи, ожидающие одобрения');
...
// 1.2 CB RC 2 beta 2:
DEFINE('_UE_USERNAME_OR_EMAIL','Аты-жөні или адрес эл.почты');
// 1.2 CB RC 2 beta 2 backend:
DEFINE('_UE_SAVE','Сохранить');
DEFINE('_UE_LOGIN_TYPE','Тип поля входа на сайт');
DEFINE('_UE_LOGIN_TYPE_DESC','Вход возможен по комбинации Аты-жөні + пароль, Аты-жөні или адрес эл.почты + пароль или адрес эл.почты + пароль. Модуль входа CB также принимает это устроение соответственно.');
...
// 1.2 CB RC 4 backend:
DEFINE('_UE_USERNAME_OR_AUTH','Аты-жөні, адрес эл.почты или задействуйте плагины авторизации CMS');
...
DEFINE('_UE_SITE_FIRSTNAME','Аты-жөні');
DEFINE('_UE_SITE_DOLZHNOST','Лауазым');
DEFINE('_UE_SITE_TELEFON','Телефон');
DEFINE('_UE_SITE_COMPANY','Бірлестік');
DEFINE('_UE_SITE_CITY','Қала');
DEFINE('_UE_SITE_COUNTRY','Ел');
DEFINE('_UE_SITE_ADRESS','Мекенжай');
DEFINE('_UE_SITE_SUBSCRIBE','Қолхат');
DEFINE('_UE_SITE_SUBSCRIBE_TYPE','Қолхаттың түрi ');
DEFINE('_UE_SITE_LOGIN','Логин');
DEFINE('_UE_SITE_PASSWORD','Пароль');
