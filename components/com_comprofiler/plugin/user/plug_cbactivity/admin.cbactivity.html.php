...
class HTML_cbactivityAdmin {
	...
	public function showPlugin( $menu, $xml, $user, $plugin ) {
	...
	public function showActivity( $rows, $pageNav, $input, $user, $plugin ) {
		global $_CB_framework;
	...
	public function showActivityEdit( $row, $input, $user, $plugin ) {
		global $_CB_framework;
	...
	public function showConfig( $input, $user, $plugin ) {
		global $_CB_framework;
	...
	private function setTitle( $title, $class ) {
