...
if (!$omitDefaultOutput){
	...
	echo '<div class="cbPosLeft cbPosTopHalf">'.$menu_profile[0]->content.'</div>';
...
function uddeIMshowAbout($myself, $item_id, $versionstring, $usedlanguage, $config) {
	...
	echo "<p>PMS component for Mambo 4.5, Joomla 1.0, 1.5, 1.6, 1.7, 2.5, 3.0, and 3.1<br />";
	echo "&copy; 2007-2013 Stephan Slabihoud, &copy; 2005-2006 by Benjamin Zweifel</p>\n";
