...
*/
	...
	echo '<span><input type="text" name="username" id="mod_login_username'.$id_sfx.'" class="inputbox'.$class_sfx.' input-medium" size="'.$name_lenght.'"' . $bgstyleUser . ' /></span>';
	if ($horizontal) {
		echo "&nbsp;\n";
	} elseif ( $jVersion == 2 ) {
		echo '</p>';
	...
	echo '<span><input type="password" name="passwd" id="mod_login_password'.$id_sfx.'" class="inputbox'.$class_sfx.' input-medium" size="'.$pass_lenght.'"' . $bgstylePass . ' /></span>';
	if ($horizontal) {
		echo "&nbsp;\n";
	} elseif ( $jVersion == 2 ) {
		echo '</p>';
