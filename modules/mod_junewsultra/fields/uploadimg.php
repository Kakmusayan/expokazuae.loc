...
if($joomla >= '3.0') {
    ...
    $csslink = '<link rel="stylesheet" href="../../../../../templates/system/css/system.css" type="text/css" />
...
<style type="text/css">
/*<![CDATA[*/
body{ background: transparent; overflow: hidden!important;}
/*]]>*/
</style>
</head>
<body>
<b><?php echo JText::_('MOD_JUNEWS_UPLOD_MODULE'); ?></b><br /><br />
	<form enctype="multipart/form-data" method="post">
	<input type="hidden" name="MAX_FILE_SIZE" value="<?php echo $max_image_size; ?>">
	<input name="userfile" class="btn" type="file">
	<input type="submit" class="btn" value="<?php echo JText::_('MOD_JUNEWS_UPLOAD'); ?>">
	</form>
<?php
...
if (isset($_FILES["userfile"])) {
	if (is_uploaded_file($_FILES['userfile']['tmp_name'])) {
        ...
        <dd class="message notice fade">
           	<ul>
           		<li>'. JText::_('MOD_JUNEWS_ERROR1') . $max_image_size.' KB</li>
           	</ul>
        </dd>
        </dl>';
        ...
        <dd class="message notice fade">
           	<ul>
           		<li>'.JText::_('MOD_JUNEWS_ERROR2').'</li>
           	</ul>
        </dd>
        </dl>';
		} else {
        ...
        <dd class="message notice fade">
           	<ul>
           		<li>'.JText::_('MOD_JUNEWS_ERROR3').'</li>
           	</ul>
        </dd>
        </dl>';
				}
        ...
        <dd class="message notice fade">
           	<ul>
           		<li>'.JText::_('MOD_JUNEWS_ERROR4').'</li>
           	</ul>
        </dd>
        </dl>';
			}
        ...
        <dd class="message notice fade">
           	<ul>
           		<li>'.JText::_('MOD_JUNEWS_ERROR5').'</li>
           	</ul>
        </dd>
        </dl>';
	}
