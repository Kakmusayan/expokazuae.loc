...
var ColorPicker = new Class({
    ...
    initialize: function(el,options){
		...
		this.chartContainer.setStyles({position:"absolute", "z-index": 1000, cursor: "pointer","background-color":"#ccc", float:"left","overflow":"visible"});
		...
		this.colorTable.setStyles({"background-color":"#cccccc", "margin":"4px",visibility:"visible", position:"absolute", top: this.options.top + "px", left: this.options.left + "px", "z-index": 100, cursor: "pointer"});
