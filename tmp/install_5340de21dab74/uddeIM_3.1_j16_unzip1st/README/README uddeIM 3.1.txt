...
====================================================================================================
Joomla 1.6 - 3.1 users please read "INSTALLATION (JOOMLA 1.6+)" in the FAQ before installing uddeIM.
====================================================================================================
 ...
 * HOW TO UPGRADE FROM UDDEIM 2.8-3.0 TO UDDEIM 3.1 (new method, using Joomla Extension Manager)
   - How to upgrade
   - Optional steps

 * HOW TO UPGRADE FROM UDDEIM 2.3-3.0 TO UDDEIM 3.1 (old method, manually)
   - How to upgrade
   - Optional steps

 * HOW TO UPGRADE FROM UDDEIM 2.2 OR EARLIER TO UDDEIM 3.1
...
---------------
 ...
 6. Check Community Builder settings (it is not required to use CB with uddeIM but it is
    ...
    "uddeIM 3.1" otherwise the next lower version e.g. "uddeIM 2.3". It is recommended 
...
---------------
 ...
 3. Update your database tables (go to phpMyAdmin and enter following SQL statements in the SQL box, 
    ...
    When you upgrade 2.3 - 3.0 to 3.1:
    ==================================
        nothing to do
...
Upgrades from uddeIM 2.2 and below are not longer supported and explained in this document.
 ...
 1. When upgrading from uddeIM 1.7+ please upgrade to uddeIM 2.8 using the instructions found in 
    uddeIM 2.8 package first before upgrading to uddeIM 3.1.
...
- you are an experienced user and overwrite the existing files with the new files from the archive 
  when upgrading (e.g. upgrading from 2.3 to 3.1).
