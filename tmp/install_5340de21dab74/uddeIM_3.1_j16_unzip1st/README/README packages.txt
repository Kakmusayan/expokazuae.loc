...
Community Builder ("cb_") packages can be used with all Joomla 
versions.

For example:
com_uddeim        the main component for Joomla 1.0, 1.5
com_uddeim_j16    the main component for Joomla 1.6, 1.7, 2.5
com_uddeim_j30    the main component for Joomla 3.0, 3.1
...
com_uddeim_j16_english_only                           (COMPONENT)
------------------------------------------------------------------
uddeIM - the main component for Joomla 1.6, 1.7, 2.5 only 
         delivered with english language files only.
         When you have problems to upload the other component
         files because of a 2 mbyte upload limit then try this
         package.
...
cb_plug_pms_uddeim                     (COMMUNITY BUILDER PLUGIN)
------------------------------------------------------------------
...
cb_plug_pms_uddeim_inbox               (COMMUNITY BUILDER PLUGIN)
------------------------------------------------------------------
...
cb_plug_pms_uddeim_blocking            (COMMUNITY BUILDER PLUGIN)
------------------------------------------------------------------
...
cb_plug_pms_uddeim_profilelink         (COMMUNITY BUILDER PLUGIN)
------------------------------------------------------------------
